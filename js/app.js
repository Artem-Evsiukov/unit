...
(function ($) {
  ...
  $(function () {
    ...
    (0, _select["default"])(); //headerScroll();
    //tabsToTop();
  });
})(jQuery);
/* ------------------------------------------------------------------------------------------- */
...
/* 
function tabsToTop() {
  const btnList = document.querySelectorAll('.js-tabs-btn');

  if (!btnList.length) return;

  btnList.forEach((btn) => {
    btn.addEventListener('click', (e) => {
      const idParent = e.target.closest('.ui-block').getAttribute('id');
...
function headerScroll() {
  const linkList = document.querySelectorAll('.js-link-to');
...
},{"./components/burger-menu":3,"./components/header-fix":4,"./components/popup":5,"./components/select":6,"./components/tabs":7}],3:[function(require,module,exports){
"use strict";
...
var headerFixed = function () {
  var headerFixedInit = function headerFixedInit() {
    if (!HEADER) return;
    var heightScroll = 1; //const heightScroll = HEADER.offsetTop;
...
var SELECT_LIST = document.querySelectorAll('.js-select');
...
var _default = initSelect;
exports["default"] = _default;

},{"choices.js":1}],7:[function(require,module,exports){
"use strict";
    ...
    function attachEvents(parent) {
      ...
      tabList.forEach(function (btn) {
        btn.addEventListener('click', function (e) {
          var group = e.target.closest('[data-tab]').getAttribute('data-group');
          var contentList = document.querySelectorAll("[data-content-group='".concat(group, "']"));
          var currentTabList = document.querySelectorAll("[data-group='".concat(group, "']"));
          currentTabList.forEach(function (btn) {
